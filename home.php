<?php
	...
	$userRow = $getUser->getUser($_SESSION['user']);
?>
<!DOCTYPE html>
<html>
<head>
  	...
  	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	    ...
	    <div class="collapse navbar-collapse" id="navbarNav">
	        ...
	        <ul class="navbar-nav ml-auto">
	        	<li class="nav-item ">
		        	<span class="nav-link">
		        		<img class="img" style="height: 20px; width: 20px" src="<?php echo $userRow['img'];?>">
			...
			<div class='col mb-4'>
				<div class='card px-1 py-1 bg-light'>
					...
					<div class='card-footer text-center p-1'>
						...
						<a href='booking.php?id=".$row['cls_cars_id']."' class='btn btn-outline-primary mb-1'>Book now</a>
						<a href='update.php?id=".$row['cls_cars_id']."' class='btn btn-outline-warning mb-1'>Update the car</a>
						<a href='deletecar.php?id=".$row['cls_cars_id']."' class='btn btn-outline-danger'>Delete the car</a>
					</div>
				</div>
			</div>";
		}
